...
import 'package:crumbitez/widgets/product_card.dart';

class MyHomePage extends StatelessWidget {
    final String npm = '2306173656'; // NPM
    final String name = 'Syifa Ananda Widyati'; // Name
    final String className = 'PBP KKI'; // Class
    final List<ItemHomepage> items = [
         ItemHomepage("View Product", Icons.list, Color(0xFF4E3B31)),
         ItemHomepage("Add Product", Icons.add, Color(0xFFF5E8B9)),
         ItemHomepage("Logout", Icons.logout, Color(0xFFB19470)),
     ];
    ...
    Widget build(BuildContext context) {
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          // The title of the application "crumbitez" with white text and bold font.
          title: const Text(
            'Crumbitez',
            style: TextStyle(
              color: Colors.white,
